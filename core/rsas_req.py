    ...
    def run(self):
        ...
        for _task in self.task_list_web:
            ...
            web_payload = {
                ...
                'target_count': url_count,
                'config_task': 'taskname',
                'task_config': '',
                'task_target': urllist[1:],
                'task_name': task_name,
                'scan_method': self.web_range,
                'subdomains_scan': '0',
                'subdomains': '',
                'exec': task_start_time,
                'exec_timing_date': task_time,
                ...
                'email_address': '',
                'plugin_threads': self.Concurrent_Threads_status,
                'webscan_timeout': self.Webscan_Timeout_status,
                'page_encoding': '0',
                'coding': 'UTF8',
                'login_ifuse': 'yes',
                'user_agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36',
                'dir_level': self.Dir_level_status,
                'dir_limit': self.Dir_limit_status,
